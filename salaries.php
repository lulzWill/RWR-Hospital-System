	...
	<body>
		...
		<table class="table table-hover table-bordered table-condensed table-striped" style="margin-left: 10%; width: 80% !important;">
	 		<tr class="active">
				...
				<th class="active tableDiv">Monthly Appointment Earnings</th>
				<th class="active tableDiv">Last Paid</th>
				<th class="active tableDiv">Pay</th>
	 		</tr>
EOL;
	...
	{ 
		...
		$adjustedSalary = $salaryResults[0]->get("salary") * $docResults[0]->get("years");
		...
		echo	'<a href="#" class="btn btn-success" data-toggle="modal" data-target="#'. $object->get("position") .'Modal" data-email="'.$object->get("email").'">Pay</a>';
